                    ...
                    <tbody>
                        <?php foreach($administrator as $rec){ ?>
                            <tr class="gradeX">
                                ...
                                <td class="actions">
                                    <a href="<?php echo base_url('admin_master/master_administrator/edit/'.@$rec->id_admin);?> "><i class="fa fa-pencil"></i></a>
                                    <a href="<?php echo base_url('admin_master/master_administrator/delete/'.@$rec->id_admin);?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
