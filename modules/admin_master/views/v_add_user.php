                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio-custom radio-primary">
                            <input id="L" name="jenis_kelamin_admin" <?php if(@$admin->jenis_kelamin_admin=='L'){echo'checked';}?> type="radio" value="L" required />
                            <label for="L">Laki - Laki</label>
                        </div>
                        <div class="radio-custom radio-primary">
                            <input id="P" name="jenis_kelamin_admin" <?php if(@$admin->jenis_kelamin_admin=='P'){echo'checked';}?> type="radio" value="P" />
