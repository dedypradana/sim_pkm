<ul class="breadcrumb">
    ...
    <li class="active">Survey Area</li>
</ul>
<div class="row margin-bottom-40">
    <!-- BEGIN SIDEBAR -->
    <div class="sidebar col-md-3 col-sm-3">
        <ul class="list-group margin-bottom-25 sidebar-menu">
            <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> Survey</a></li>
            ...
            <div class="row">
                <div class="col-md-7 col-sm-7">
                    <form class="form-horizontal form-without-legend" role="form">
                        <div class="form-group">
                            <label for="email" class="col-lg-4 control-label">Nopeg <span class="require">*</span></label>
                            <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-4 padding-left-0">
                                <a href="page-forgotton-password.html">Need Help ?</a>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="col-md-4 col-sm-4 pull-right">
                    <div class="form-info">
                        ...
                        <p>Login ini diintegrasikan dengan LDAP (<i>Lightweight Directory Access Protocol</i>) dalam implementasinya</p>
                    </div>
                </div>
            </div>
        </div>
