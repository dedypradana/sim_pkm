            ...
            <div class="panel-body">
                <table class="table table-striped table-hover mb-none">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Catatan Dosen</td>
                            <td><?php echo @$pkm->note_dosen; ?></td>
                        </tr>
                        <tr>
                            <td>Catatan Admin</td>
                            <td><?php echo @$pkm->note_admin; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Status</td>
                            <td><?php echo @$pkm->acc_dosen != 1 ? 'Belum Acc Dosen' : 'Sudah Acc Dosen'; ?>, <?php echo @$pkm->acc_admin != 1 ? 'Belum Acc Admin' : 'Sudah Acc Admin'; ?></td>
                        </tr>
                        <tr>
