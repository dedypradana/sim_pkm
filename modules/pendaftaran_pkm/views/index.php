                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-icon">
                                ...
                                <input type="text" name="nim" id="nim" class="form-control" placeholder="NIM" value="<?php echo @$c_pkm->nim;?>" <?php echo $c_daftar ? 'readonly':'';?> required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="col-lg-12">
                                <ol>
                                    ...
                                    <li>(<?php echo @$rec->nim;?>) <?php echo @$rec->nama;?>, <?php echo @$rec->jurusan;?></li>
                                    <?php } ?>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="form-group" id="fd_<?php echo $init;?>">
                      <label class="col-md-3 control-label">Anggota</label>
                           <div class="col-sm-8">
                            <div class="row">
                                <div class="col-sm-3">
                                    <input type="text" name="nim_anggota[]" value="<?php echo @$rec->nim;?>" class="form-control" placeholder="NIM">
                                </div>
                                <div class="visible-xs mb-md"></div>
                                <div class="col-sm-4">
                                    <input type="text" name="nama_anggota[]" value="<?php echo @$rec->nama;?>" class="form-control" placeholder="Nama">
                                </div>
                                <div class="visible-xs mb-md"></div>
                                <div class="col-sm-4">
                                    <input type="text" name="jurusan_anggota[]" value="<?php echo @$rec->jurusan;?>" class="form-control" placeholder="Jurusan">
                                </div>
                                <div class="col-sm-1">
                                    <button type="button" onclick="rm(<?php echo $init;?>,<?php echo @$rec->id_anggota;?>);" class="btn btn-danger">
                      ...
                      <label class="col-md-3 control-label">Anggota</label>\n\
                           <div class="col-sm-8">\n\
                            <div class="row">\n\
                                ...
                                <div class="visible-xs mb-md"></div>\n\
                                <div class="col-sm-4">\n\
                                    <input type="text" name="jurusan_anggota[]" class="form-control" placeholder="Jurusan">\n\
                                </div>\n\
                                <div class="col-sm-1">\n\
