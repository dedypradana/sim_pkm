...
# Database: sim_pkm
# Generation Time: 2016-09-16 18:20:09 +0000
# ************************************************************
...
LOCK TABLES `master_informasi` WRITE;
/*!40000 ALTER TABLE `master_informasi` DISABLE KEYS */;

INSERT INTO `master_informasi` (`id_informasi`, `artikel_informasi`, `pengumuman_informasi`, `berkas`)
VALUES
	(1,'asdf','asdf','adsf'),
	(3,'test','test','test');

/*!40000 ALTER TABLE `master_informasi` ENABLE KEYS */;
UNLOCK TABLES;
